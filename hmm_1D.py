...
data_set = load_data('rfq_15min_count_hmm.csv')

# Take differences
data_set_diffs = data_set.values[1:, :] - data_set.values[:-1, :]

print(data_set_diffs)
...
test_seq = [10]*20
predicted_hidden_state, prediction = make_prediction2(model, test_seq)

print('Predicted hidden state is: ')
print(predicted_hidden_state)

print('Prediction is: ') #prediction of next value is 1.74 not 10 ! 1.74 is mean of inc regime distribution. Measured,
print(prediction)  # Comment - robust to crazy inputs...
